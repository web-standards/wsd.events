...
body {
  counter-reset: slide;
  font: 28px/2 'PF DIN TEXT PRO', sans-serif;
  color: #ADADAD;
}
...
.debug .slide {
  background: url("http://rhr.me/pres/node_modules/shower-ok-invert/images/ribbon.svg") 865px 0 no-repeat, url("../images/grid-4x3.svg") no-repeat, white;
}

.slide h2 {
  margin: 0 0 37px;
  color: #eb722e;
  font: 400 50px/1 'PF DIN TEXT PRO Medium', sans-serif;
}
.slide h3 {
  font-size: 32px;
  font-family: 'PF DIN TEXT PRO Medium';
...
.slide.shout h2 {
  ...
  color: #eb722e;
  text-align: center;
  font: 150px/1 'PF DIN TEXT PRO Medium', sans-serif;
  -webkit-transform: translateY(-50%);
  -moz-transform: translateY(-50%);
  -ms-transform: translateY(-50%);
  -o-transform: translateY(-50%);
...
.thin {
  font-family: 'PF DIN TEXT PRO Light' !important;
}
