...
for($i_div = 1; $i_div <= $divs_in_set; $i_div++)
{
	...
	for($i_section = 1; $i_section <= $sections_in_set; $i_section++)
	{
		...
		for($i_article = 1; $i_article <= $articles_in_set; $i_article++)
		{
			...
			# (01)	$css .= "		#p$paragraph_number {color: red;}\n";
			# (02)	$css .= "		.p$paragraph_number {color: red;}\n";
			# (03)	$css .= "		.p$paragraph_number > span {color: red;}\n";
			# (04)	$css .= "		.p$paragraph_number span {color: red;}\n";
			# (05)	$css .= "		.p$paragraph_number * {color: red;}\n";
			# (06)	$css .= "		.a$article_number p:last-child {color: red;}\n";
			# (07)	$css .= "		.a$article_number p:nth-child(-" . ($paragraphs_in_set + 1) . "n+$paragraphs_in_set) {color: red;}\n";
			# (08)	$css .= "		.a$article_number p:nth-of-type(-" . ($paragraphs_in_set + 1) . "n+$paragraphs_in_set) {color: red;}\n";
			# (09)	$css .= "		body.page div section article[class*=\"$article_number\" :last-child * {color: red;}\n";
			# (10)	$css .= "		* * * [class] :last-child * {color: red;}\n";
