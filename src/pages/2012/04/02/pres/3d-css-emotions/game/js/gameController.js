...
(function(global){
    ...
    $('nav .scores').click($.proxy(this.showScores,this));
    $('nav .rules').click($.proxy(this.showRules,this));
    $('nav .new-game').click($.proxy(this.showGame,this));
    $('nav .change-name').click($.proxy(this.setName,this));

    $('.score .back').click($.proxy(this.showNavigation,this));
    $('.rules .back').click($.proxy(this.showNavigation,this));
    
    $(".game-over .ok").click($.proxy(this.showNavigation,this));
    $(".name-popup .ok").click($.proxy(this.saveName,this));
    
    $(".data-panel .pause").click($.proxy(this.pauseSwitch,this));
    $(".data-panel .quit").click($.proxy(this.showNavigation,this));
